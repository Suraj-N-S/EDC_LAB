...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../DIODE_REVERSE/circuit.png}
    \caption{PN Junction Diode Reverse Bias Circuit Schematic.}
    \label{fig:diode_rev_circuit}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../DIODE_REVERSE/0-30v.png}
...
\caption{PN Junction Diode (1N4007) Forward-Bias Readings}\label{tab:pn_forward_readings}\\
\toprule
\textbf{S.No.} & $V_{sup}$ (V) & $V_D$ (V) & $I_D$ (mA) \\
\midrule
1 & 0.00 & 0.00 & 0.000 \\
2 & 0.10 & 0.10 & 0.000 \\
3 & 0.20 & 0.20 & 0.000 \\
...
14 & 6.97 & 0.68 & 6.220 \\
15 & 9.01 & 0.69 & 8.220 \\
16 & 11.04 & 0.70 & 10.220 \\
17 & 13.08 & 0.71 & 12.220 \\
18 & 15.11 & 0.72 & 14.220 \\
19 & 17.14 & 0.72 & 16.220 \\
20 & 19.17 & 0.73 & 18.220 \\
21 & 20.97 & 0.73 & 20.000 \\
\bottomrule
\end{longtable}
\begin{longtable}{c c c}
\caption{PN Junction Diode (1N4007) Reverse-Bias Readings}\label{tab:pn_reverse_readings}\\
\toprule
\textbf{S.No.} & $V_R$ (V) & $I_R$ ($\mu$A) \\
\midrule
1 & 0 & 0 \\
2 & -5 & 0 \\
3 & -10 & 0 \\
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Reverse Saturation Current:} The measured reverse current remained \textbf{$0\,\mu\text{A}$} from $0\text{ V}$ to $-30\text{ V}$; hence $I_s$ was below the DMM resolution and no reverse breakdown was observed in the tested range.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../ZENER_FORWARD/circuit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../ZENER_REVERSE/circuit.png}
...
\small
\begin{longtable}{c c c c}
\caption{Zener Diode (1N4733A) Forward-Bias Readings}\label{tab:zener_forward_readings}\\
\toprule
\textbf{S.No.} & $V_{sup}$ (V) & $V_Z$ (V) & $I_Z$ (mA) \\
\midrule
1 & 0.00 & 0.00 & 0.000\\
2 & 0.10 & 0.10 & 0.000\\
3 & 0.20 & 0.20 & 0.000\\
...
\end{longtable}
\begin{longtable}{c c c c}
\caption{Zener Diode (1N4733A) Reverse-Bias Readings}\label{tab:zener_reverse_readings}\\
\toprule
\textbf{S.No.} & $V_{sup}$ (V) & $V_Z$ (V) & $I_Z$ (mA) \\
\midrule
1 & -0.00 & -0.00 & 0.000\\
...
27 & -11.99 & -5.14 & -6.800\\
28 & -14.04 & -5.17 & -8.800\\
29 & -16.08 & -5.19 & -10.800\\
30 & -18.12 & -5.21 & -12.800\\
31 & -20.15 & -5.22 & -14.800\\
32 & -22.18 & -5.23 & -16.800\\
33 & -24.21 & -5.24 & -18.800\\
34 & -25.43 & -5.25 & -20.000\\
\bottomrule
\end{longtable}
\subsection{Experimental V--I Characteristics \& Plots}
\begin{figure}[H]
...
\toprule
\textbf{Circuit} & \textbf{Input $V_{pp}$ (V)} & \textbf{Measured Clip Level} & \textbf{Inference} \\
\midrule
Positive Clipper & 4.0 & $+1.60\text{ V}$ & Upper peak clipped cleanly above $V_{ref}+V_\gamma$. \\
Negative Clipper & 4.0 & $-1.68\text{ V}$ & Lower peak clipped cleanly below $-V_{ref}-V_\gamma$. \\
Biased Clipper   & 4.0 &  $+1.20\text{ V}$ \& $-0.92\text{ V}$ & Dual-level clipping limits peak-to-peak swing. \\
\bottomrule
\end{tabular}
...
\subsection{Theoretical Background}
A clamper shifts the DC level of an AC waveform without changing its peak-to-peak value significantly. The diode and capacitor charge during one half-cycle and add a DC offset during the other half-cycle, producing positive or negative clamping depending on the diode orientation.
\subsection{Circuit Diagrams, Simulations \& Hardware DSO Waveforms}
...
\textbf{Inference :} in \textbf{Positive Clamper : } Upward DC shift; min level clamped at $-V_\gamma$. \\

In \textbf{Negative Clamper : } Downward DC shift; max level clamped at $+V_\gamma$.  
